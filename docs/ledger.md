...
- **Ledger**: A ledger is the state of the distributed Fonero database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/Fonero-ledger.x`](/src/xdr/Fonero-ledger.x))


`Fonero-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `fonero-core` can be configured to upload detailed historical
