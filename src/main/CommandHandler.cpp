...
{
    retStr = "<b>Welcome to fonero-core!</b><p>";
    ...
    retStr +=
        ...
        "Cursors are used by dependent services to tell fonero - core which "
...
CommandHandler::manualClose(std::string const& params, std::string& retStr)
{
    ...
    {
        retStr =
            "Set MANUAL_CLOSE=true in the fonero-core.cfg if you want this "
            "behavior";
    }
}
...
CommandHandler::generateLoad(std::string const& params, std::string& retStr)
{
    ...
    else
    {
        retStr = "Set ARTIFICIALLY_GENERATE_LOAD_FOR_TESTING=true in "
                 "the fonero-core.cfg if you want this behavior";
    }
}
