...
{
std::string
StringMaker<fonero::OfferState>::convert(fonero::OfferState const& os)
{
    return fmt::format(
        ...
        os.type == fonero::OfferType::PASSIVE ? "passive" : "active");
}

std::string
StringMaker<fonero::CatchupRange>::convert(fonero::CatchupRange const& cr)
{
...
std::string
StringMaker<fonero::historytestutils::CatchupPerformedWork>::convert(
    fonero::historytestutils::CatchupPerformedWork const& cm)
{
    return fmt::format("{}, {}, {}, {}, {}, {}, {}, {}",
