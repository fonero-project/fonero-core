...
void
HerderImpl::valueExternalized(uint64 slotIndex, FoneroValue const& value)
{
    // record metrics
...
HerderImpl::triggerNextLedger(uint32_t ledgerSeqToTrigger)
{
    ...
    FoneroValue newProposedValue(txSetHash, nextCloseTime, emptyUpgradeSteps,
                                  0);
