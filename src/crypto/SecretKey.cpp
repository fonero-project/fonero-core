...
{
size_t
hash<fonero::PublicKey>::operator()(fonero::PublicKey const& k) const noexcept
{
    assert(k.type() == fonero::PUBLIC_KEY_TYPE_ED25519);

    return std::hash<fonero::uint256>()(k.ed25519());
}
}
