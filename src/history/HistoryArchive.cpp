...
{
    return std::string("fonero-history.json");
}
...
HistoryArchiveState::HistoryArchiveState() : server(FONERO_CORE_VERSION)
{
    uint256 u;
...
HistoryArchiveState::HistoryArchiveState(uint32_t ledgerSeq,
    ...
    : server(FONERO_CORE_VERSION), currentLedger(ledgerSeq)
{
