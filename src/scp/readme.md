...
in the file [Fonero-SCP.x](../xdr/Fonero-SCP.x)

The `fonero-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.fonero.org/papers/fonero-consensus-protocol.pdf).
