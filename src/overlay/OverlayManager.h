 ...
 * `FoneroMessage`, in the file src/xdr/Fonero-overlay.x
 *
 ...
 *
 * The `FoneroMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(FoneroMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(FoneroMessage const& msg,
                                Peer::pointer peer) = 0;
