...
* Disk I/O at the operating system level (ie: unit is typically in blocks/s), both reads and writes of the fonero-core process
...
fonero-core has a built-in load generator that allows to inject transactions on private networks.
